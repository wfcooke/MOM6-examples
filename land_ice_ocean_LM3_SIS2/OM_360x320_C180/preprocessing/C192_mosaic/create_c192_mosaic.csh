...
ln -s ../ocean_hgrid.nc .
ln -s ../topog.nc .
make_hgrid --grid_type gnomonic_ed --nlon 384  --grid_name C192_grid
make_solo_mosaic --num_tiles 6 --dir . --mosaic_name C192_mosaic --tile_file C192_grid.tile1.nc,C192_grid.tile2.nc,C192_grid.tile3.nc,C192_grid.tile4.nc,C192_grid.tile5.nc,C192_grid.tile6.nc
make_solo_mosaic --num_tiles 1 --dir ./ --mosaic_name ocean_mosaic --tile_file ocean_hgrid.nc --periodx 360.
make_coupler_mosaic --atmos_mosaic C192_mosaic.nc --ocean_mosaic ocean_mosaic.nc --ocean_topog topog.nc --mosaic_name grid_spec
#rm -f hydrology*.nc
...
(tar cvhf mosaic.tar C192_grid* C192_mosaic* land_mask* ocean_hgrid* ocean_mask* ocean_mosaic* topog* grid_spec.nc)
